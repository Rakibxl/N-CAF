...
namespace Architecture.Core.Repository.Context.FluentAPIMapping
{
    public class ProfISEEInfoConfiguration : IEntityTypeConfiguration<ProfISEEInfo>
    {
        public void Configure(EntityTypeBuilder<ProfISEEInfo> iseeInfo)
        {
            ...
            iseeInfo.Property(bs => bs.ISEEValue).HasColumnType("decimal(10,2)").HasDefaultValue(0.0).IsRequired();
            iseeInfo.Property(bs => bs.Point).HasColumnType("decimal(10,2)").HasDefaultValue(0.0).IsRequired();
            iseeInfo.Property(bs => bs.ISEEFamilyIncome).HasColumnType("decimal(10,2)").HasDefaultValue(0.0).IsRequired();
            iseeInfo.Property(bs => bs.ISPAmount).HasColumnType("decimal(10,2)").HasDefaultValue(0.0).IsRequired();
            iseeInfo.Property(bs => bs.ISEAmount).HasColumnType("decimal(10,2)").HasDefaultValue(0.0).IsRequired();
            iseeInfo.Property(bs => bs.ISRAmount).HasColumnType("decimal(10,2)").HasDefaultValue(0.0).IsRequired();
