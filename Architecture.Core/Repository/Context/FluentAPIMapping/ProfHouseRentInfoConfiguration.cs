...
namespace Architecture.Core.Repository.Context.FluentAPIMapping
{
    public class ProfHouseRentInfoConfiguration : IEntityTypeConfiguration<ProfHouseRentInfo>
    {
        public void Configure(EntityTypeBuilder<ProfHouseRentInfo> houserentInfo)
        {
            ...
            houserentInfo.Property(bs => bs.MonthlyRentAmount).HasColumnType("decimal(3,2)");
            houserentInfo.Property(bs => bs.ServiceChargeAmount).HasColumnType("decimal(3,2)");
            ...
            houserentInfo.Property(bs => bs.SharePercent).HasColumnType("decimal(3,2)");
            ...
            houserentInfo.Property(bs => bs.LoanAmount).HasColumnType("decimal(3,2)");
            houserentInfo.Property(bs => bs.PaidAmount).HasColumnType("decimal(3,2)");
            houserentInfo.Property(bs => bs.RentAmount).HasColumnType("decimal(3,2)");
