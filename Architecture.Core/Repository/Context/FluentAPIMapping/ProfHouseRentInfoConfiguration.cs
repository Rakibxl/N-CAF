...
namespace Architecture.Core.Repository.Context.FluentAPIMapping
{
    public class ProfHouseRentInfoConfiguration : IEntityTypeConfiguration<ProfHouseRentInfo>
    {
        public void Configure(EntityTypeBuilder<ProfHouseRentInfo> houserentInfo)
        {
            ...
            houserentInfo.Property(bs => bs.MonthlyRentAmount).HasColumnType("decimal(10,2)");
            houserentInfo.Property(bs => bs.ServiceChargeAmount).HasColumnType("decimal(10,2)");
            ...
            houserentInfo.Property(bs => bs.SharePercent).HasColumnType("decimal(5,2)");
            ...
            houserentInfo.Property(bs => bs.LoanAmount).HasColumnType("decimal(10,2)");
            houserentInfo.Property(bs => bs.PaidAmount).HasColumnType("decimal(10,2)");
            houserentInfo.Property(bs => bs.RentAmount).HasColumnType("decimal(10,2)");
