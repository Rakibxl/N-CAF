...
namespace Architecture.Core.Repository.Context.FluentAPIMapping
{
    public class JobInfoConfiguration : IEntityTypeConfiguration<JobInformation>
    {
        public void Configure(EntityTypeBuilder<JobInformation> jobInfo)
        {
            ...
            jobInfo.Property(bs => bs.IsCommon).HasDefaultValue(false).IsRequired(false);
            jobInfo.Property(bs => bs.OperatorTimeFrame).HasColumnType("decimal(10,2)").HasDefaultValue(0.0);
            jobInfo.Property(bs => bs.IsHighlighted).HasDefaultValue(false).IsRequired(false);
            ...
            jobInfo.Property(bs => bs.ChildAgeMin).IsRequired(false);
            ...
            jobInfo.Property(bs => bs.IsPregnant).HasDefaultValue(false).IsRequired(false);
            ...
            jobInfo.Property(bs => bs.IsEligibleForUnlimitedResidencePermit).HasDefaultValue(false).IsRequired(false);
            jobInfo.Property(bs => bs.IsEligibleForCityzenShipApply).HasDefaultValue(false).IsRequired(false);
            jobInfo.Property(bs => bs.HasUnlimitedResidencePermit).HasDefaultValue(false).IsRequired(false);
            jobInfo.Property(bs => bs.IsEligibleForUnlimitedResidencePermit).HasDefaultValue(false).IsRequired(false);
