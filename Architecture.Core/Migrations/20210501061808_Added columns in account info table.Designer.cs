...
namespace Architecture.Core.Migrations
{
    ...
    [Migration("20210501061808_Added columns in account info table")]
    partial class Addedcolumnsinaccountinfotable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Architecture.Core.Entities.Accounts.AccountInfo", b =>
                {
            ...
            modelBuilder.Entity("Architecture.Core.Entities.Accounts.Transaction", b =>
                {
                    ...
                    b.Property<bool>("IsAutoAccounting")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Architecture.Core.Entities.Accounts.TransactionRequest", b =>
                {
                    b.Property<int>("TransactionRequestId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Architecture.Core.Entities.ApplicationUser", b =>
                {
                    ...
                    b.Property<string>("OperatorKeywordIds")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Architecture.Core.Entities.JobInfo", b =>
                {
                    ...
                    b.Property<decimal>("BranchRequiredAmount")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(10,2)")
                        .HasDefaultValue(0m);
                    ...
                    b.Property<decimal>("ClientRequiredAmount")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(10,2)")
                        .HasDefaultValue(0m);
                    ...
                    b.Property<decimal>("OperatorRequiredAmount")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(10,2)")
                        .HasDefaultValue(0m);
            ...
            modelBuilder.Entity("Architecture.Core.Entities.LU.PaymentType", b =>
                {
                    b.Property<int>("PaymentTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            PaymentTypeId = 3,
                            IsActive = true,
                            PaymentTypeName = "Paypal Payment"
                        },
                        new
                        {
                            PaymentTypeId = 4,
                            IsActive = true,
                            PaymentTypeName = "Bank Payment"
                        });
                });

            modelBuilder.Entity("Architecture.Core.Entities.LU.Province", b =>
                {
            ...
            modelBuilder.Entity("Architecture.Core.Entities.LU.SectionName", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            SectionNameId = 9,
                            IsActive = true,
                            SectionDescription = "Movement Info"
                        },
                        new
                        {
                            SectionNameId = 10,
                            IsActive = true,
                            SectionDescription = "Legal Info"
                        },
                        new
                        {
                            SectionNameId = 11,
                            IsActive = true,
                            SectionDescription = "Insurance Info"
                        },
                        new
                        {
                            SectionNameId = 12,
                            IsActive = true,
                            SectionDescription = "Bank Info"
                        },
                        new
                        {
                            SectionNameId = 13,
                            IsActive = true,
                            SectionDescription = "Worker Info"
                        },
                        new
                        {
                            SectionNameId = 14,
                            IsActive = true,
                            SectionDescription = "Asset Info"
                        },
                        new
                        {
                            SectionNameId = 15,
                            IsActive = true,
                            SectionDescription = "Deligation Info"
                        },
                        new
                        {
                            SectionNameId = 16,
                            IsActive = true,
                            SectionDescription = "ISEE Info"
                        });
                });
            ...
            modelBuilder.Entity("Architecture.Core.Entities.Notification.NotificationInfo", b =>
                {
                    b.Property<int>("NotificationInfoId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Architecture.Core.Entities.Accounts.TransactionDetail", b =>
                {
                    ...
                    b.HasOne("Architecture.Core.Entities.Accounts.Transaction", "Transaction")
            ...
            modelBuilder.Entity("Architecture.Core.Entities.Accounts.TransactionRequest", b =>
                {
                    b.HasOne("Architecture.Core.Entities.LU.PaymentType", "PaymentType")
                        .WithMany()
            ...
            modelBuilder.Entity("Architecture.Core.Entities.Notification.NotificationInfo", b =>
                {
                    b.HasOne("Architecture.Core.Entities.OfferInfo", "OfferInfo")
                        .WithMany()
                        .HasForeignKey("OfferInfoId");
