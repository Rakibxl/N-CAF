...
const routes: Routes = [
    {
        ...
        children: [
            ...
            { path: 'occupation/:id', component: OccupationHistoryFormComponent, data: { extraParameter: 'analytics' } },
            { path: 'family-info', component: FamilyInformationComponent, data: { extraParameter: 'analytics' } },
            { path: 'family-info/:id', component: FamilyInformationFormComponent, data: { extraParameter: 'analytics' } },
            { path: 'education', component: EducationalInformationComponent, data: { extraParameter: 'analytics' } },
            { path: 'education/:id', component: EducationalInformationFormComponent, data: { extraParameter: 'analytics' } },
            { path: 'address', component: AddressInformationComponent, data: { extraParameter: 'analytics' } },
            { path: 'address/:id', component: AddressInformationFormComponent, data: { extraParameter: 'analytics' } },
            { path: 'house-rent', component: HouseRentInformationComponent, data: { extraParameter: 'analytics' } },
            { path: 'house-rent/:id', component: HouseRentInformationFormComponent, data: { extraParameter: 'analytics' } },
            { path: 'document-info/:id', component: DocumentInformationFormComponent, data: { extraParameter: 'analytics' } },
            { path: 'income-info', component: IncomeInformationComponent, data: { extraParameter: 'analytics' } },
            { path: 'income-info/:id', component: IncomeInformationFormComponent, data: { extraParameter: 'analytics' } },
            { path: 'movement-info', component: MovementInformationComponent, data: { extraParameter: 'analytics' } },
            { path: 'movement-info/:id', component: MovementInformationFormComponent, data: { extraParameter: 'analytics' } },
            { path: 'legal-info', component: LegalInformationComponent, data: { extraParameter: 'analytics' } },
            { path: 'legal-info/:id', component: LegalInformationFormComponent, data: { extraParameter: 'analytics' } },
            { path: 'insurance-info', component: InsuranceInformationComponent, data: { extraParameter: 'analytics' } },
            { path: 'insurance-info/:id', component: InsuranceInformationFormComponent, data: { extraParameter: 'analytics' } },
            { path: 'bank-info', component: BankInformationComponent, data: { extraParameter: 'analytics' } },
            { path: 'bank-info/:id', component: BankInformationFormComponent, data: { extraParameter: 'analytics' } },
            { path: 'worker-info', component: WorkerInformationComponent, data: { extraParameter: 'analytics' } },
            { path: 'worker-info/:id', component: WorkerInformationFormComponent, data: { extraParameter: 'analytics' } },
            { path: 'asset-info', component: AssetInformationComponent, data: { extraParameter: 'analytics' } },
            { path: 'asset-info/:id', component: AssetInformationFormComponent, data: { extraParameter: 'analytics' } },
            { path: 'deligation-info', component: DeligationInformationComponent, data: { extraParameter: 'analytics' } },
            { path: 'deligation-info/:id', component: DeligationInformationFormComponent, data: { extraParameter: 'analytics' } },
            { path: 'isee-info', component: IseeInformationComponent, data: { extraParameter: 'analytics' } },
            { path: 'isee-info/:id', component: IseeInformationFormComponent, data: { extraParameter: 'analytics' } },
