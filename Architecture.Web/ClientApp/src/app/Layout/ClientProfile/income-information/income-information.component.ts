  ...
  ngOnInit() {
    ...
    public fnCustomrTrigger(event) {
        ...
        if (event.action == "new-record") {
            debugger;
            this.router.navigate(['/client-profile/income-info-new']);
            debugger
        }
    ...
    public ptableSettings: IPTableSetting = {
        ...
        tableColDef: [
            ...
            { headerName: 'Montly Income', width: '15%', internalName: 'equivalentmoneymax', sort: true, type: "" },
            { headerName: 'Year', width: '15%', internalName: 'equivalentmoneymin', sort: true, type: "" },
            { headerName: 'Month', width: '10%', internalName: 'moneyaverage', sort: true, type: "" },
            { headerName: 'Document', width: '10%', internalName: 'ownertype', sort: true, type: "" },
            { headerName: 'Status', width: '20%', internalName: 'ownershippercentage', sort: true, type: "" },
