...
export class ClientListComponent implements OnInit {
  ...
  public ptableSettings: IPTableSetting = {
    ...
    tableColDef: [
      ...
      { headerName: 'Date Of Birth', width: '12%', internalName: 'dateOfBirth', sort: true, type: "", onClick: 'true' },
      { headerName: 'Phone Number', width: '15%', internalName: 'phoneNumber', sort: true, type: "", onClick: 'true' },
      { headerName: 'Email', width: '12%', internalName: 'email', sort: true, type: "", onClick: 'true' },
      { headerName: 'Selected City', width: '12%', internalName: 'selectedCity', sort: true, type: "", onClick: 'true' },
      { headerName: 'Zip Code', width: '10%', internalName: 'zipCode', sort: true, type: "", onClick: 'true' },
